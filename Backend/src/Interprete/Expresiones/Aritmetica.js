...
class Aritmetica extends Expresion {
  ...
  ejecutar(entorno) {
    ...
    console.log("Valor 1: "+this.op1.tipo+" Valor 2: "+this.op2.tipo);
    ...
    switch (this.operador) {
      case "+":
        if (
          ...
          this.op1.tipo === TipoDato.ENTERO &&
          this.op2.tipo === TipoDato.DECIMAL
        ) {
          ...
          this.op1.tipo === TipoDato.DECIMAL &&
          this.op2.tipo === TipoDato.ENTERO
        ) {
          this.tipo = TipoDato.DECIMAL;
          this.valor = this.op1.valor + this.op2.valor;
          ...
          this.tipo = TipoDato.DECIMAL;
          this.valor = this.op1.valor + this.op2.valor;
        }else if(this.op1.tipo === TipoDato.DECIMAL && this.op2.tipo === TipoDato.BOOLEANO){
            this.tipo = TipoDato.DECIMAL;
            this.valor = this.op1.valor + (this.op2.valor ? 1 : 0);
        }else if(this.op1.tipo === TipoDato.DECIMAL && this.op2.tipo === TipoDato.CHAR){
            this.tipo = TipoDato.DECIMAL;
            this.valor = this.op1.valor + this.op2.valor.charCodeAt(0);
        }else if(this.op1.tipo === TipoDato.DECIMAL && this.op2.tipo === TipoDato.CADENA){
            this.tipo = TipoDato.CADENA;
            this.valor = this.op1.valor + this.op2.valor;;
        }else if(this.op1.tipo === TipoDato.BOOLEANO && this.op2.tipo === TipoDato.ENTERO){
            this.tipo = TipoDato.ENTERO;
            this.valor = (this.op1.valor ? 1 : 0) + this.op2.valor;
        }else if(this.op1.tipo === TipoDato.BOOLEANO && this.op2.tipo === TipoDato.DECIMAL){
            this.tipo = TipoDato.DECIMAL;
            this.valor = (this.op1.valor ? 1 : 0) + this.op2.valor;
        ...
        }else if(this.op1.tipo === TipoDato.CHAR && this.op2.tipo === TipoDato.DECIMAL){
            this.tipo = TipoDato.DECIMAL;
            this.valor = this.op1.valor.charCodeAt(0) + this.op2.valor;
            ...
            this.tipo = TipoDato.CADENA;
            this.valor = this.op1.valor + this.op2.valor;
            console.log("Valor de la cadena: "+this.valor)
        }else if(this.op1.tipo === TipoDato.CADENA && this.op2.tipo === TipoDato.ENTERO){
            this.tipo = TipoDato.CADENA;
            this.valor = this.op1.valor + this.op2.valor;
        }else if(this.op1.tipo === TipoDato.CADENA && this.op2.tipo === TipoDato.DECIMAL){
            this.tipo = TipoDato.CADENA;
            this.valor = this.op1.valor + this.op2.valor;
      ...
      case "%":
        ...
        case "$":
            ...
            else if(this.op1.tipo === TipoDato.ENTERO && this.op2.tipo === TipoDato.DECIMAL){
                this.tipo = TipoDato.DECIMAL;
                this.valor = Math.pow(this.op1.valor, this.op2.valor);
            }
            else if(this.op1.tipo === TipoDato.DECIMAL && this.op2.tipo === TipoDato.ENTERO){
                this.tipo = TipoDato.DECIMAL;
                this.valor = Math.pow(this.op1.valor, this.op2.valor);
            }
            else if(this.op1.tipo === TipoDato.DECIMAL && this.op2.tipo === TipoDato.DECIMAL){
                this.tipo = TipoDato.DECIMAL;
                this.valor = Math.pow(this.op1.valor, this.op2.valor);
            }
            else{
    ...
    getNodo() {
        ...
        nodo.agregarHijo(this.op1.getNodo());
        nodo.agregarHijo(this.operador);
        nodo.agregarHijo(this.op2.getNodo());
        return nodo;
    }
